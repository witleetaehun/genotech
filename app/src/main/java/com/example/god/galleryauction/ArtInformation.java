...
//            //System.out.println("doInBackground : "+C_tagId);
//            //change(C_tagId);
//            return null;
//        }
    //}
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (tag != null) {
            ...
            //System.out.print(tagss);
            //C_tagId = toHexString(tagId);
            //Toast.makeText(getApplicationContext() , toHexString(tagId) , Toast.LENGTH_SHORT).show();
